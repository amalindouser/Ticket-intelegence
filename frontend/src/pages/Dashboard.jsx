    ...
    <div className="space-y-6">
      ...
      <div className="flex flex-col sm:flex-row sm:items-center justify-between gap-3">
        ...
        <div className="flex items-center gap-3">
          ...
          <div className="flex items-center gap-3">
            {syncResult && (
              <div className="flex items-center gap-1.5 text-xs text-green-600 bg-green-50 px-3 py-1.5 rounded-lg animate-fadeIn whitespace-nowrap">
                ...
                <span>{syncResult.synced} baru, {syncResult.skipped} update</span>
              </div>
            )}
            <button onClick={async () => {
              setSyncing(true);
              setSyncResult(null);
              const res = await fetch("/api/tickets/sync", { method: "POST" }).catch(() => null);
      ...
      {syncing && (
        <div className="bg-white rounded-2xl shadow-sm border border-amber-100 p-4 animate-fadeIn">
          <div className="flex items-center justify-between mb-2">
            <div className="flex items-center gap-2">
              ...
              <span className="text-sm font-medium text-amber-700">Menyinkronkan tiket dengan Freshdesk...</span>
            </div>
